...
replaceitem entity @s hotbar.0 stick{Unbreakable:1,display:{Name:'[{"text":"Not-Kill","italic":false,"color":"blue"}, {"selector":"@p"}]',Lore:['[{"text":"Just a normal stick","italic":false,"color":"gray"}]']},Enchantments:[{}],HideFlags:39} 1
replaceitem entity @s hotbar.1 filled_map{map: 0} 1
replaceitem entity @s hotbar.8 written_book 1

scoreboard players set @s killCooldown 200